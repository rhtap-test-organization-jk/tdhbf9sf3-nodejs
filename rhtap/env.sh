...
export IMAGE_URL=${IMAGE_URL-rhtap-quay-quay-rhtap-quay.apps.cluster-qpvqg.qpvqg.sandbox8.opentlc.com/rhtap/rhtap-qe-nodejs:$CI_TYPE-$TAG}
...
export GITOPS_REPO_URL=https://github.com/rhtap-test-organization-jk/tdhbf9sf3-nodejs-gitops
